...
export class SubscriptionAnnouncementInquiryService {
  ...
  getOfferDetails(params: Params): Observable<offerDetail[]> {
    ...
    if (environment.apiMock) {
      endpoint = `assets/mock/api/v1/file/subscription-announcement-inquiry.xml`;
    }
    const httpParams = new HttpParams({
      fromObject: { ...params, Qtype: QtypeParamsSetting.PUBLIC_OFFERINGS },
    });
